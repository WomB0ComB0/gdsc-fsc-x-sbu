...
function GlobalNav() {
  return (
    <nav className="shadow-bottom sticky top-0 grid h-16 w-full grid-cols-2 items-center justify-center bg-[hsla(0,0%,100%,.8)] px-8 py-4 backdrop-blur-sm backdrop-saturate-150">
